...
BOOST_AUTO_TEST_CASE(constructor_test) {
	...
	BOOST_TEST( bt2.slot == (978307200 - 946684800)/3/**2*/, "Time point constructor gives wrong value");
}
...
BOOST_AUTO_TEST_CASE(conversion_test) {
	...
	t = (fc::time_point)bt1;
	BOOST_TEST(t.time_since_epoch().to_seconds() == 946685400ll/*946684900ll*/, "Time point conversion failed");
