...
def makeGenesis():
    ...
    run('cp ' + os.path.abspath(args.contracts_dir) + '/eosio.bios/eosio.bios.abi ' + os.path.abspath(args.config_dir))
    run('cp ' + os.path.abspath(args.contracts_dir) + '/eosio.bios/eosio.bios.wasm ' + os.path.abspath(args.config_dir))
    run('cp ' + os.path.abspath(args.contracts_dir) + '/eosio.msig/eosio.msig.abi ' + os.path.abspath(args.config_dir))
    run('cp ' + os.path.abspath(args.contracts_dir) + '/eosio.msig/eosio.msig.wasm ' + os.path.abspath(args.config_dir))
...
def startNode(nodeIndex, bpaccount, key):
    ...
    cmd = (
        ...
        '    --http-server-address 0.0.0.0:' + str(8887 + nodeIndex) +
